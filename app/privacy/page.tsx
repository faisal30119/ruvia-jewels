...
export const metadata = {
  title: 'Privacy Policy | Ruvia Jewels',
  description: 'Learn about how Ruvia Jewels collects, protects, and uses customer personal information.',
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white border border-gray-200/80 p-6 sm:p-8 space-y-6 text-sm text-gray-600 leading-relaxed shadow-sm">
          <section>
            ...
            <p>
              At <strong>Ruvia Jewels</strong>, we respect your privacy. When you visit our website or place an order, we collect personal information necessary to fulfill your purchases, including your name, email address, phone number, delivery address, and payment preferences.
            </p>
          </section>
