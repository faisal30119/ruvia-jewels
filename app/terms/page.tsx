...
export const metadata = {
  title: 'Terms & Conditions | Khadie Jewels',
  description: 'Read the terms and conditions governing the use of Khadie Jewels website and purchase services.',
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white border border-gray-200/80 p-6 sm:p-8 space-y-6 text-sm text-gray-600 leading-relaxed shadow-sm">
          <section>
            ...
            <p>
              This website is operated by <strong>Khadie Jewels</strong>. Throughout the site, the terms &quot;we&quot;, &quot;us&quot;, and &quot;our&quot; refer to Khadie Jewels. By visiting our site or purchasing products from us, you engage in our service and agree to be bound by the following terms and conditions.
            </p>
          </section>
          ...
          <section className="pt-4 border-t border-gray-100">
            ...
            <p>
              All prices listed on Khadie Jewels are in Indian Rupees (INR) inclusive of applicable taxes. Prices are subject to change without notice. All online transactions are processed through encrypted 256-bit SSL Razorpay payment gateways ensuring absolute card and banking data security.
            </p>
          </section>
          ...
          <section className="pt-4 border-t border-gray-100">
            ...
            <p>
              All content, images, graphics, logos, and product designs featured on this website belong exclusively to Khadie Jewels. Reproduction, distribution, or unauthorized commercial use of any asset without prior written consent is strictly prohibited.
            </p>
          </section>
        </div>
      </div>
